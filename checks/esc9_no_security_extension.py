"""
AD CS ESC9: Certificate templates with CT_FLAG_NO_SECURITY_EXTENSION, preventing
the SID security extension from being embedded. Enables impersonation through
UPN manipulation when StrongCertificateBindingEnforcement < 2.
"""
...
@check(risk="High", category="ESC9 — No Security Extension")
class ESC9NoSecurityExtensionCheck(ADCSCheck):
