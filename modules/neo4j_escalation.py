...
class EscalationPathsMixin:
    ...
    def _get_escalation_paths_v2(self, entity):
        ...
        raw_results = self.conn.query(query, parameters={'entity': entity}, name="get_escalation_paths_v2")
