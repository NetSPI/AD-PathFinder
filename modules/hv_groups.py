...
# Built-in default groups already covered by the default groups check.
# Used by common groups analysis to avoid overlap.
BUILTIN_GROUP_NAMES = [
    'DOMAIN USERS',
    'DOMAIN COMPUTERS',
    'AUTHENTICATED USERS',
...
def high_value_groups_for_domain(domain):
    return admin_groups_for_domain(domain) + [
        f"{name}@{domain}" for name in PROTECTED_MARKER_GROUPS
    ]
